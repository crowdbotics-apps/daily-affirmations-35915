...
## Project Structure
    ...
    ├── daily_affirmations_35915  # Django project configurations
...
1. Clone this repo and `cd daily_affirmations_35915`
...
2. Clone this repo and `cd daily_affirmations_35915`
